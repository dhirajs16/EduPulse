...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <a href="{{ route('assignments.create', $teacher->id) }}" class="btn btn-primary">Add New Assignment</a>
        </div>
    </div>
    <!--end breadcrumb-->
    ...
    function renderTable() {
        ...
        tableBody.innerHTML = paginatedItems.map(item => `
            <tr>
                ...
                <td>
                    <a href="{{ url('assignments') }}/${item.id}/edit" class="btn btn-sm" title="Edit"><i class='bx bxs-edit'></i></a>
                    <form action="{{ url('assignments') }}/${item.id}" method="POST" onsubmit="return confirm('Are you sure?');" style="display:inline;">
                        @csrf
                        @method('DELETE')
