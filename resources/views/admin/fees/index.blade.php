...
@section('content')
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <a href="{{ route('admin.fees.create') }}" class="btn btn-primary radius-30"
                    style="background-color: #244960"><i class="bx bxs-plus-square"></i>Add New Fee</a>
            </div>
        </div>
        <!--end breadcrumb-->
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row align-items-end mb-3 g-3">
                    ...
                    <div class="col-md-2">
                        <input type="number" id="yearSearch" class="form-control" placeholder="Search by Year"
                            min="1900" max="{{ date('Y') + 5 }}">
                    </div>

                    <div class="col-md-2">
                        <input type="number" id="monthSearch" class="form-control" placeholder="Search by Month (1-12)"
                            min="1" max="12">
                    </div>
                ...
                <div id="feesData" data-items='{!! $fees->map(function ($fee) {
                        return [
                            'id' => $fee->id,
                            'name' => $fee->name ?? '',
