...
@section('content')
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <a href="{{ route('admin.fees.index') }}" class="btn btn-primary radius-30"
                ...
                <form action="{{ route('admin.fees.store') }}" method="POST">
                    ...
                    <div class="form-body mt-4">
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="number" min="1" max="12" name="month" id="month"
                                    ...
                                    value="{{ old('month', date('n')) }}" required>
                                @error('month')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="border border-3 p-4 rounded">
                            <button type="submit" class="btn btn-primary radius-30" style="background-color: #244960">Add
                                Fee</button>
                        </div>
                    </div>
