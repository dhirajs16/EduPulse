                ...
                <div class="form-body mt-4">
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="number" step="0.01" min="0" name="amount_paid" id="amount_paid" class="form-control @error('amount_paid') is-invalid @enderror" value="{{ old('amount_paid', $transaction->amount_paid) }}" required>
                            @error('amount_paid')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="border border-3 p-4 rounded">
                        <button type="submit" class="btn btn-primary radius-30" style="background-color: #244960;">Update Transaction</button>
                    </div>
                </div>
            </form>
        </div>
