                ...
                <div class="form-body mt-4">
                    <div class="row">
                        ...
                        <div class="col-lg-3 mb-3">
                            ...
                            <input type="number" min="0" name="credit_hours" id="credit_hours"
                    ...
                    <div class="border border-3 p-4 rounded">
                        <button type="submit" class="btn btn-primary radius-30" style="background-color: #244960;">Update Subject</button>
                    </div>
                </div>
