    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <a href="{{ route('admin.role-users.create') }}" class="btn btn-primary radius-30"
                    style="background-color: #244960;"><i class="bx bxs-plus-square"></i>{{ __('Add New Role Users') }}</a>
            </div>
        </div>
        <!--end breadcrumb-->
        ...
        <div class="card">
            <div class="card-body p-4">
                <h4 class="card-title">{{ __('Create Role Users') }}</h4>
                <hr>
            ...
            <div class="card-footer">
                <div class="card-actions">
                    ...
                    <button class="btn btn-primary radius-30" style="background-color: #244960;"
                        onclick="$('#roleUserForm').submit()" type="submit">{{ __('Create') }}</button>
                </div>
            </div>
        </div>
    </div>
